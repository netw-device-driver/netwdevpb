...
const (
	...
	CacheStatusReply_None CacheStatusReply_CacheResourceStatus = 0
	// ToBeProcessed -> new data, not processed
	CacheStatusReply_ToBeProcessed CacheStatusReply_CacheResourceStatus = 1
	// UpdateBeingProcessed -> data is merged in the tree
	CacheStatusReply_UpdateBeingProcessed CacheStatusReply_CacheResourceStatus = 2
	// UpdateProcessedSuccess -> data, processed successfully
	CacheStatusReply_UpdateProcessedSuccess CacheStatusReply_CacheResourceStatus = 3
	// UpdateProcessedSuccessNatsUpdatePending -> data, processed successfully but nats update is missing
	CacheStatusReply_UpdateProcessedSuccessNatsUpdatePending CacheStatusReply_CacheResourceStatus = 4
	// UpdateProcessedFailed -> data, processed unsuccessfully
	CacheStatusReply_UpdateProcessedFailed CacheStatusReply_CacheResourceStatus = 5
	// UpdateProcessedFailedNatsUpdatePending -> data, processing Failed but nats update is missing
	CacheStatusReply_UpdateProcessedFailedNatsUpdatePending CacheStatusReply_CacheResourceStatus = 6
	// DependencyMissing -> data with missing dependency
	CacheStatusReply_DependencyMissing CacheStatusReply_CacheResourceStatus = 7
	// LeafRefDependency -> data with leafref dependency cannot delete
	CacheStatusReply_LeafRefDependency CacheStatusReply_CacheResourceStatus = 8
	// DeletePending -> data with pending gnmi delete
	CacheStatusReply_DeletePending CacheStatusReply_CacheResourceStatus = 9
	// DeletePendingWithParentDependency -> data with pending parent gnmi delete
	CacheStatusReply_DeletePendingWithParentDependency CacheStatusReply_CacheResourceStatus = 10
	// DeleteWithMissingDependency -> data with No pending gnmi update
	CacheStatusReply_DeleteWithMissingDependency CacheStatusReply_CacheResourceStatus = 11
	// UpdatePending -> data with pending update
	CacheStatusReply_UpdatePending CacheStatusReply_CacheResourceStatus = 12
)
...
var (
	CacheStatusReply_CacheResourceStatus_name = map[int32]string{
		0:  "None",
		1:  "ToBeProcessed",
		2:  "UpdateBeingProcessed",
		3:  "UpdateProcessedSuccess",
		4:  "UpdateProcessedSuccessNatsUpdatePending",
		5:  "UpdateProcessedFailed",
		6:  "UpdateProcessedFailedNatsUpdatePending",
		7:  "DependencyMissing",
		8:  "LeafRefDependency",
		9:  "DeletePending",
		10: "DeletePendingWithParentDependency",
		11: "DeleteWithMissingDependency",
		12: "UpdatePending",
	}
...
type DeviationUpdate_ActionType int32

const (
	DeviationUpdate_Replace DeviationUpdate_ActionType = 0
	DeviationUpdate_Update  DeviationUpdate_ActionType = 1
	DeviationUpdate_Delete  DeviationUpdate_ActionType = 2
)

// Enum value maps for DeviationUpdate_ActionType.
var (
	DeviationUpdate_ActionType_name = map[int32]string{
		0: "Replace",
		1: "Update",
		2: "Delete",
	}
	DeviationUpdate_ActionType_value = map[string]int32{
		"Replace": 0,
		"Update":  1,
		"Delete":  2,
	}
...
func (x DeviationUpdate_ActionType) Enum() *DeviationUpdate_ActionType {
	p := new(DeviationUpdate_ActionType)
	*p = x
	return p
}

func (x DeviationUpdate_ActionType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (DeviationUpdate_ActionType) Descriptor() protoreflect.EnumDescriptor {
	return file_configMessage_proto_enumTypes[2].Descriptor()
}

func (DeviationUpdate_ActionType) Type() protoreflect.EnumType {
	return &file_configMessage_proto_enumTypes[2]
}

func (x DeviationUpdate_ActionType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use DeviationUpdate_ActionType.Descriptor instead.
func (DeviationUpdate_ActionType) EnumDescriptor() ([]byte, []int) {
	return file_configMessage_proto_rawDescGZIP(), []int{4, 0}
}
...
type DeviationUpdate struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Resource string                     `protobuf:"bytes,1,opt,name=Resource,proto3" json:"Resource,omitempty"`
	Action   DeviationUpdate_ActionType `protobuf:"varint,2,opt,name=Action,proto3,enum=netwdevpb.DeviationUpdate_ActionType" json:"Action,omitempty"`
}

func (x *DeviationUpdate) Reset() {
	*x = DeviationUpdate{}
	if protoimpl.UnsafeEnabled {
...
func (x *DeviationUpdate) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DeviationUpdate) ProtoMessage() {}

func (x *DeviationUpdate) ProtoReflect() protoreflect.Message {
	mi := &file_configMessage_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DeviationUpdate.ProtoReflect.Descriptor instead.
func (*DeviationUpdate) Descriptor() ([]byte, []int) {
	return file_configMessage_proto_rawDescGZIP(), []int{4}
}

func (x *DeviationUpdate) GetResource() string {
	if x != nil {
		return x.Resource
	}
	return ""
...
func (x *DeviationUpdate) GetAction() DeviationUpdate_ActionType {
	if x != nil {
		return x.Action
	}
	return DeviationUpdate_Replace
}
...
var file_configMessage_proto_rawDesc = []byte{
	...
	0x22, 0xb9, 0x04, 0x0a, 0x12, 0x43, 0x61, 0x63, 0x68, 0x65, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65,
	...
	0x65, 0x6e, 0x64, 0x65, 0x6e, 0x63, 0x69, 0x65, 0x73, 0x22, 0x31, 0x0a, 0x0a, 0x41, 0x63, 0x74,
	0x69, 0x6f, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x12, 0x0b, 0x0a, 0x07, 0x52, 0x65, 0x70, 0x6c, 0x61,
	0x63, 0x65, 0x10, 0x00, 0x12, 0x0a, 0x0a, 0x06, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x10, 0x01,
	0x12, 0x0a, 0x0a, 0x06, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x10, 0x02, 0x22, 0x12, 0x0a, 0x10,
	0x43, 0x61, 0x63, 0x68, 0x65, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x52, 0x65, 0x70, 0x6c, 0x79,
	0x22, 0x46, 0x0a, 0x12, 0x43, 0x61, 0x63, 0x68, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52,
	...
	,
	...
	,
	...
	0x10, 0x01, 0x12, 0x0a, 0x0a, 0x06, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x10, 0x02, 0x22, 0x16,
	0x0a, 0x14, 0x44, 0x65, 0x76, 0x69, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x55, 0x70, 0x64, 0x61, 0x74,
	0x65, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x32, 0x55, 0x0a, 0x0b, 0x43, 0x61, 0x63, 0x68, 0x65, 0x55,
	...
	,
}
...
var file_configMessage_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_configMessage_proto_goTypes = []interface{}{
	...
	(DeviationUpdate_ActionType)(0),           // 2: netwdevpb.DeviationUpdate.ActionType
	...
	(*DeviationUpdate)(nil),                   // 7: netwdevpb.DeviationUpdate
	(*DeviationUpdateReply)(nil),              // 8: netwdevpb.DeviationUpdateReply
}
var file_configMessage_proto_depIdxs = []int32{
	...
	3, // 2: netwdevpb.CacheStatusReply.Data:type_name -> netwdevpb.CacheUpdateRequest
	2, // 3: netwdevpb.DeviationUpdate.Action:type_name -> netwdevpb.DeviationUpdate.ActionType
	...
	7, // 6: netwdevpb.Deviation.Update:input_type -> netwdevpb.DeviationUpdate
	4, // 7: netwdevpb.CacheUpdate.Update:output_type -> netwdevpb.CacheUpdateReply
	6, // 8: netwdevpb.CacheStatus.Request:output_type -> netwdevpb.CacheStatusReply
	8, // 9: netwdevpb.Deviation.Update:output_type -> netwdevpb.DeviationUpdateReply
